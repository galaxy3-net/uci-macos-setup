...
[ -e  "~\Documents\Azure Labs.rtsz" ] || curl "https://raw.githubusercontent.com/galaxy3-net/uci-windows-setup/dev/files/Azure Labs.rtsz" --output "~\Documents\Azure Labs.rtsz"

[ -e  "~\Documents\UCI-Cybersecurity.rtsz" ] || curl "https://raw.githubusercontent.com/galaxy3-net/uci-windows-setup/dev/files/UCI-Cybersecurity.rtsz" --output "~\Documents\UCI-Cybersecurity.rtsz"

[ -e  "~\Documents\UCI-Cybersecurity.html" ] || curl "https://raw.githubusercontent.com/galaxy3-net/uci-windows-setup/dev/files/UCI-Cybersecurity.html" --output "~\Documents\UCI-Cybersecurity.html"
